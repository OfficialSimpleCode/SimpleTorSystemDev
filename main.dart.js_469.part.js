...
aRX(d,e,f,g,h,i,j,k,l){var x=0,w=A.l(y.b),v,u,t
var $async$aRX=A.h(function(m,n){if(m===1)return A.i(n,w)
for(;;)switch(x){case 0:x=3
return A.d(A.aR(e,A.aT("makeNewPaymentRequest","")),$async$aRX)
case 3:t=n
if(!$.ct().qk(e,C.tM,l.c)){v=null
x=1
break}x=t===!0?4:6
break
case 4:x=$.af?7:9
