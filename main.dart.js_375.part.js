...
i=n+1
h=o[n]
if(j){n=new A.nx(d.a_U(p,l,l+h,!0),D.M,null)
v.push(n)
g=f.d
...
bIQ:function bIQ(d,e,f,g,h,i,j,k,l,m,n){var _=this
_.b=d
_.c=e
_.d=f
_.e=g
...
w.push(A.n7(0,A.mi(A.jb(v,v,v,new B.bIQ(u.c,u.f,u.d,u.e,u.x,x,u.r,v,u.b,v,v),D.bf),!0,v),0))
w.push(new A.I(u.a,this.c,v))
return new A.bS(D.aB,v,u.w,D.X,w,v)}}
B.bCZ.prototype={
gdXr(d){var x,w=this,v=w.c
if(v===$){x=D.c.eZ(w.a,new B.drs(w))
w.c!==$&&A.cQ()
w.c=x
v=x}return v}}
B.bIQ.prototype={
...
break $label0$0}if(C.aWk===r){x=A.dP($.b_().w)
x.aS(new A.a3b(new A.ab(0,0,0+d.a,0+d.b)))
break $label0$0}if(C.a9d===r){x=A.dP($.b_().w)
w=d.a
...
t=d.gkb()
s=d.gkb()/2
x.aS(new A.mx(A.hG(new A.ab(w,v,w+u,v+t),new A.aQ(s,s))))
break $label0$0}x=A.dP($.b_().w)
x.aS(new A.rZ(new A.ab(0,0,0+d.a,0+d.b)))
...
C.a9d=new B.aEg(0,"Circle")
C.a9e=new B.aEg(1,"RRect")
C.aWk=new B.aEg(3,"Oval")
C.bY8=new B.b1I(1,"emptyDashPattern")
C.bY9=new B.b1I(2,"negativeDashPattern")
